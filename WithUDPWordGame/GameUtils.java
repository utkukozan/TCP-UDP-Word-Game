...
public class GameUtils {
    ...
    public static boolean isWordValid(String newWord) throws IOException {
        return isWordRepeating(newWord) && isWordInList(newWord);
    }

    private static boolean isWordInList(String newWord) throws IOException {
    ...
    private static boolean isWordRepeating(String newWord) throws IOException {
    ...
    private static void addWordToTxt(String newWord) {
        String str = newWord + System.lineSeparator();
        try {
            Files.write(Paths.get(PAST_WORDS_FILE), str.getBytes(), StandardOpenOption.APPEND);
        } catch (IOException e) {
